...
import { getVJContent, getKilaxExclusiveContent } from "@/lib/api";
// Genre rows now use Supabase
    ...
    async function fetchCriticalData() {
      try {
        ...
        const [latestMovies, latestSeries, kilaxExclusiveData, genreRows] = await Promise.all([
          (await import('@/lib/api')).getMovies(12), // Reduced from 20
          (await import('@/lib/api')).getSeries(12), // Reduced from 20
          getKilaxExclusiveContent(8), // Kilax Exclusive content
          (await import('@/lib/genre-home-supabase')).getGenreRowsForHomeSupabase(12) // Reduced limit
        ]);
